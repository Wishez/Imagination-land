...
(function (factory) {
	...
	var _getWords = function _getWords() {
		return JSON.parse(localStorage.getItem(_filteredWords));
	};
  ...
  * 
  */
	var DocumentFilter = function DocumentFilter() {
  ...
  */
	var _showBlock = function _showBlock(node) {
		...
		if (!node.tagName) node.textContent = message;else node.innerHTML = message;
	};
	// Base regexp
	...
	var _findAndRemoveImage = function _findAndRemoveImage(node) {
		...
		if (text.length > 5000) return false;else if (_regexp.test(text)) parent.remove();else _findAndRemoveImage(parent.parentNode);
  ...
  */
	DocumentFilter.prototype.filterDOM = function (root) {
		...
		if (length > 1) {
			...
			this.filterTextInNode(children[0]);
			var childrenLength = children[0].length;
...
var _DocumentFilter = require('./DocumentFilter.js');
...
$(function () {
	...
	var addWord = function addWord(e) {
		e.preventDefault();
	...
	var removeWord = function removeWord(e) {
...
},{"./DocumentFilter.js":1,"jquery":3}],3:[function(require,module,exports){
(function (global){
